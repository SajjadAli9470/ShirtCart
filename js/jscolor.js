	...
	var jscolor = (function () { // BEGIN jscolor
		...
		var jsc = {
			...
			addClass: function (elm, className) {
				...
				// me=document.getElementById('customizeOne').style.background=colorchanged;
				if (elm.classList !== undefined) {
			...
			hexColor: function (r, g, b) {
				// changedValue(colorchanged);
				document.getElementById('customizeOne').style.background = colorchanged;
			...
			pub: function (targetElement, opts) {
				...
				if (this.value !== undefined) {
					...
					// get initial color from the 'value' property
		...
		jsc.pub.background = function (color) {
			// console.log(fromString(color));
			// console.log(this.toRGBAString());
			var backgrounds = [];
